...
<div class="container main-wrapper">
    <div class="register-card">
        ...
        <form id="multi-step-form" method="POST" action="<?php echo e(url('/register')); ?>">
            <?php echo csrf_field(); ?>
            
            <div class="form-step form-step-active" id="step-1">
                <div class="mb-3">
                    <input type="text" class="form-control custom-input" id="nama" placeholder="Nama Lengkap" value="<?php echo e(old('name')); ?>" required>
                </div>

                <div class="mb-3">
                    <input type="text" class="form-control custom-input" id="npm-input" placeholder="NPM (Nomor Pokok Mahasiswa)" value="<?php echo e(old('npm')); ?>" required>
                </div>
                ...
                <div class="mb-3">
                    <input type="email" class="form-control custom-input" id="email-input" placeholder="Email" value="<?php echo e(old('email')); ?>" required>
                </div>

                <div class="mb-3">
                    <input type="text" class="form-control custom-input" id="telepon-input" placeholder="Nomor Telepon / WA" value="<?php echo e(old('telepon')); ?>" required>
                </div>
            ...
            <div class="form-step" id="step-2">
                <div class="mb-3">
                    <input type="text" class="form-control custom-input" name="angkatan" placeholder="Angkatan (Contoh: 2023)" value="<?php echo e(old('angkatan')); ?>" required>
                </div>
            ...
            <p class="login-back-text">
                Sudah punya akun? <a href="<?php echo e(url('/login')); ?>" class="login-link fw-bold text-decoration-none">Login disini</a>
            </p>
        </form>
...
</html><?php /**PATH D:\PROJEK TA TARRY\ta-ukm\resources\views/Auth/register.blade.php ENDPATH**/ ?>