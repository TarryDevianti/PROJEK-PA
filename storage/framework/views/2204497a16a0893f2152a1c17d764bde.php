    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <div class="navbar-nav mx-auto">
                <a class="nav-link-custom active" href="<?php echo e(url('/dashboard')); ?>">Beranda</a>
                ...
                <a class="nav-link-custom" href="<?php echo e(url('/pusat-bantuan')); ?>">FAQ</a>
            </div>
            
            <div class="d-flex align-items-center">
                <span class="me-3 fw-semibold text-dark"><i class="fa-regular fa-user me-1"></i> <?php echo e(Auth::user()->name); ?></span>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-custom p-4 text-center text-dark">
                ...
                <p class="text-muted small mb-3"><?php echo e(Auth::user()->npm); ?></p>
                <hr>
                <div class="text-start small">
                    <div class="mb-2"><strong>Program Studi:</strong> <br><span class="text-secondary"><?php echo e(Auth::user()->prodi ?? Auth::user()->program_studi); ?></span></div>
                    <div class="mb-2"><strong>Angkatan:</strong> <br><span class="text-secondary"><?php echo e(Auth::user()->angkatan); ?></span></div>
                    <div class="mb-0"><strong>No. Telepon:</strong> <br><span class="text-secondary"><?php echo e(Auth::user()->no_telepon ?? Auth::user()->telepon); ?></span></div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-custom p-4 text-dark">
                ...
                <?php if($pendaftaran): ?>
                    <div class="p-4 bg-light rounded border text-center">
                        <p class="mb-1 text-muted fw-semibold text-uppercase">UKM Pilihan: <span class="text-dark"><?php echo e($pendaftaran->ukm_tujuan); ?></span></p>
                        <p class="mb-3 text-muted small">Divisi: <?php echo e($pendaftaran->divisi_tujuan); ?></p>
                        ...
                        <?php if($pendaftaran->catatan_admin): ?>
                            <div class="alert alert-secondary mt-3 mb-0 text-start small border-0 shadow-sm">
                                ...
                                <span class="text-muted"><em>"<?php echo e($pendaftaran->catatan_admin); ?>"</em></span>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
                    <div class="p-5 text-center">
                        ...
                        <a href="<?php echo e(url('/pendaftaran/isi')); ?>" class="btn btn-warning text-white fw-bold px-4 py-2 rounded-pill shadow-sm">
...
</html><?php /**PATH D:\PROJEK TA TARRY\ta-ukm\resources\views/user/dashboard.blade.php ENDPATH**/ ?>