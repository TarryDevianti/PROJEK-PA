                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-jabatan"><?php echo e(ucfirst($item->jabatan)); ?></span></td>
                                <td><?php echo e($item->user->name ?? $item->nama); ?></td>
                                <td><?php echo e($item->user->npm ?? '-'); ?></td>
                                <td><?php echo e($item->periode); ?></td>
                                <td>
                                    <div class="btn-group-aksi">
                                        <!-- Tombol Detail -->
                                        <a href="#" class="btn-aksi btn-detail" title="Detail" data-toggle="modal" data-target="#detailModal<?php echo e($item->id); ?>">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <!-- Tombol Edit -->
                                        <a href="#" class="btn-aksi btn-edit" title="Edit" data-toggle="modal" data-target="#editModal<?php echo e($item->id); ?>">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <!-- Tombol Hapus -->
                                        <form action="<?php echo e(route('admin_pengurus.data_pengurus.destroy', $item->id)); ?>" method="POST" style="display:inline-block;">
                                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="tambahModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('admin_pengurus.data_pengurus.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="user_id" id="user_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($a->id); ?>"><?php echo e($a->name); ?> (<?php echo e($a->npm); ?>)</option>
...
<!-- Detail Modal -->
<div class="modal fade" id="detailModal<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel<?php echo e($item->id); ?>" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: rgba(212, 163, 115, 0.08); border-bottom: 1px solid rgba(212, 163, 115, 0.15);">
                <h5 class="modal-title" id="detailModalLabel<?php echo e($item->id); ?>" style="color: #e9c46a;">
            ...
            <div class="modal-body">
                <p><strong>Nama:</strong> <?php echo e($item->user->name ?? $item->nama); ?></p>
                <p><strong>NPM:</strong> <?php echo e($item->user->npm ?? '-'); ?></p>
                <p><strong>Jabatan:</strong> <?php echo e(ucfirst($item->jabatan)); ?></p>
                <p><strong>Periode:</strong> <?php echo e($item->periode); ?></p>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="#" method="POST">
                ...
                <div class="modal-header" style="background: rgba(212, 163, 115, 0.08); border-bottom: 1px solid rgba(212, 163, 115, 0.15);">
                    <h5 class="modal-title" id="editModalLabel<?php echo e($item->id); ?>" style="color: #e9c46a;">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="jabatan" class="form-control">
                            <option value="ketua" <?php echo e($item->jabatan == 'ketua' ? 'selected' : ''); ?>>Ketua</option>
                            <option value="sekretaris" <?php echo e($item->jabatan == 'sekretaris' ? 'selected' : ''); ?>>Sekretaris</option>
                            <option value="bendahara" <?php echo e($item->jabatan == 'bendahara' ? 'selected' : ''); ?>>Bendahara</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Periode</label>
                        <input type="text" name="periode" class="form-control" value="<?php echo e($item->periode); ?>">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_pengurus.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJEK TA TARRY\ta-ukm\resources\views/admin_pengurus/data_pengurus/index.blade.php ENDPATH**/ ?>