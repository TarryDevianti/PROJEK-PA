        ...
        SYIAH KUALA
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-4" id="mainNavbar">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('login') }}" class="btn btn-outline-dark fw-bold px-4 rounded-pill">Login</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active" data-bs-interval="3500">
                                    <img src="{{ asset('assets/img/kegiatan_seuramoe.jpeg') }}" class="carousel-hero-img" alt="Kegiatan Seni UKM Seuramoe">
                                ...
                                <div class="carousel-item" data-bs-interval="3500">
                                    <img src="{{ asset('assets/img/kegiatan_ululalbab.jpeg') }}" class="carousel-hero-img" alt="Kajian LDF Ulul Albab">
                                    <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded-3 py-1">
                                        <p class="mb-0 small fw-bold text-warning">Karakter Islami & Syiar - LDF Ulul Albab</p>
                                    </div>
                                </div>
                                <div class="carousel-item" data-bs-interval="3500">
                                    <img src="{{ asset('assets/img/kegiatan_barracuda.jpg') }}" class="carousel-hero-img" alt="Jelajah Alam UKM Barracuda">
                                    <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded-3 py-1">
 ...
 <section class="container my-5 py-5" id="jelajah-ukm">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 d-flex align-items-stretch">
        <div class="col">
            <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                <div>
                    <div class="ukm-logo-wrapper">
                         <img src="{{ asset('assets/img/seuramoe.png') }}"
         alt="Logo Seuramoe"
         style="width:120px; height:120px; object-fit:contain;">
                ...
                <div class="mt-4 pt-2">
                    <a href="{{ route('ukm.detail-publik', ['slug' => 'ukm-seramoe']) }}"
        ...
        <div class="col">
            <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                <div>
                    <div class="ukm-logo-wrapper">
                        <img src="{{ asset('assets/img/ululalbab.png') }}" alt="Logo Ulul Albab" class="ukm-logo-img">
                    </div>
                ...
                <div class="mt-4 pt-2">
                  <a href="{{ route('ukm.detail-publik', ['slug' => 'ukm-ldf-ulul-albab']) }}"
                        class="btn btn-dark w-100 rounded-pill py-2.5 fw-bold">
                        Detail
                        </a>
                </div>
        ...
        <div class="col">
            <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 d-flex flex-column justify-content-between">
                <div>
                    <div class="ukm-logo-wrapper">
                        <img src="{{ asset('assets/img/barracuda.png') }}" alt="Logo Barracuda" class="ukm-logo-img">
                    </div>
                ...
                <div class="mt-4 pt-2">
                   <a href="{{ route('ukm.detail-publik', ['slug' => 'ukm-barracuda']) }}"
                    class="btn btn-dark w-100 rounded-pill py-2.5 fw-bold">
                    Detail
                    </a>
                </div>
   ...
   <section class="py-5 border-top" id="faq-section">
    <div class="container py-4" style="max-width: 900px;">
      ...
      <section>
    <div class="container">
        {{-- Kita gunakan @if(isset($faqs)) seperti kode Anda --}}
